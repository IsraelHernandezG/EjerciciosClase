...

{
	...
	//projection = glm::ortho(-5.0f, 5.0f, -3.0f, 3.0f, 0.1f, 10.0f);                                       //volumen de la vista
	...
	glDrawArrays(GL_QUADS, 0, 24);
	// Letra G
	model = glm::translate(model, glm::vec3(6.0f, 6.0f, 0.0));
	projectionShader.setMat4("model", model);
	glDrawArrays(GL_QUADS, 0, 24);
	model = glm::translate(model, glm::vec3(-1.0f, 0.0, 0.0));
	projectionShader.setMat4("model", model);
	...
	glDrawArrays(GL_QUADS, 0, 24);
	//Letra I
	model = glm::translate(model, glm::vec3(8.0f, 3.0f, 0.0));
	projectionShader.setMat4("model", model);
	glDrawArrays(GL_QUADS, 0, 24);
	model = glm::translate(model, glm::vec3(-1.0f, 0.0, 0.0));
	projectionShader.setMat4("model", model);
	...
	projectionShader.setMat4("model", model);
	glDrawArrays(GL_QUADS, 0, 24);
	model = glm::translate(model, glm::vec3(2.0f, -1.0, 0.0));
	projectionShader.setMat4("model", model);
	glDrawArrays(GL_QUADS, 0, 24);
	model = glm::translate(model, glm::vec3(0.0f, -1.0, 0.0));
	projectionShader.setMat4("model", model);
