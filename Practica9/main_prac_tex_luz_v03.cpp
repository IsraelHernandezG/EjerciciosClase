...
void LoadTextures()
{
	...
	t_graf = generateTextures("Texturas/grafitti01.png", 1);
	...
	glBindTexture(GL_TEXTURE_2D, t_graf);
}
...
void display(void)
{
	...
	//cara de abajo
	lightingShader.setInt("material_diffuse", t_panda);
	...
	lightingShader.setInt("material_specular", t_graf);
