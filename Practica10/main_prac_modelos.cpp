...
{
	if (play) {
		movKit_z += 0.03f * direccion;
		girollanta += 0.8f * direccion;
	}
...
void display(Shader shader, Model modelo, Model llantas)
{
	...
	model = glm::rotate(model, glm::radians(girollanta), glm::vec3(1.0f, 0.0f, 0.0f)); // para el cambio de direccion de las llantas:  glm::vec3(0.0f, 1.0f, 0.0f)
